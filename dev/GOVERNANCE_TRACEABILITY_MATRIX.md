...
| CAP-004 | Deterministic `gov_uninstall` command | GA | `index.ts`, `tools/gov_uninstall_sync.mjs` | runtime cases + public flow B2 | `skills/gov_uninstall/SKILL.md` | Stable baseline |
...
| CAP-013 | Release gate denominator baseline | GA | `dev/run_runtime_regression.mjs` | `SUMMARY 28/28 passed` | `dev/README.md`, `PUBLISHING.md` | Keep denominator updated when adding cases |
