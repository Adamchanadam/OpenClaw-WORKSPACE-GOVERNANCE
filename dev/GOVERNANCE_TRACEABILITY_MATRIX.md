...
| CAP-013 | Release gate denominator baseline | GA | `dev/run_runtime_regression.mjs` | `SUMMARY 33/33 passed` | `dev/README.md`, `PUBLISHING.md` | Keep denominator updated when adding cases |
